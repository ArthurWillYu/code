...
markerscanner = '/home/bioinfo/anaconda3/bin/Phyla_AMPHORA/Scripts/MarkerScanner.pl'
mafft = '/home/bioinfo/anaconda3/bin/mafft'
trimal = '/home/bioinfo/anaconda3/bin/trimal'
raxmlHPC='/home/bioinfo/anaconda3/bin/standard-RAxML-master/raxmlHPC-AVX'
fasttree = '/home/bioinfo/anaconda3/bin/fasttree'
    ...
    if os.path.splitext(fasta_f)[1].lower() not in ['.fasta','.fas','.fna']:
        ...
        for pep in peplist:
            ...
            if not pepext == '.pep':
                ...
                fsetructing_phylogenic_tree.py  = list(fseq)
                if len(fseq) > 1:
...
print('217output'+out_trimed_peps+'output2'+ tree_input_fasta)
...
if tree_software == 'fasttree':
    ...
    raxmlCMD = ['raxmlHPC-AVX -f a -s tree_input.phy -n tre -m PROTGAMMALGX -x 1000 -# 1000 -p 1000 -T 40']
